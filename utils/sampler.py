...
class DataSampler(object):
    """Sample the conditional vector and corresponding data.

    Attributes:
        sample_condvec: Generate the conditional vector for training.
        samples_original_condvec: Generate the conditional vector for
            generation using original frequency.
        sample_data: Sample data from original training data satisfying
             the sampled conditional vector.
        dim_cond_vec: Returns discrete categories dimension.
        generate_cond_from_condition_column_info: Generate condition vector
            from col   umn information.
    """

    def __init__(self, data, output_info, log_frequency):
        """Initialize the DataSampler class.
        ...
        Args:
            ...
            log_frequency (bool):
                Whether or not to use log on the frequency count.
        """
        self._data = data
        ...
        for column_info in output_info:
            if is_discrete_column(column_info):
                ...
                if log_frequency:
                    category_freq = np.log(
                        category_freq + 1
                    )  # add 1 since log(0) = -inf
    ...
    def _random_choice_prob_index(self, discrete_column_id):
        """Randomize categories of the discrete columns based on the category probability.
    ...
    def sample_condvec(self, batch):
        ...
        Returns:
            cond (batch x with #categories):
                The conditional vector.
            mask (batch x with #discrete columns):
    ...
    def dim_cond_vec(self):
        """Returns discrete categories dimension."""
        return self._n_categories

    def generate_cond_from_condition_column_info(self, condition_info, batch):
        """Generate condition vector from column information."""
